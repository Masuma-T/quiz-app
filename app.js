...
const questions = [
  ...
  {
    question: "In data analytics, what is a dashboard primarily used for?",
    options: [
      "Writing code",
      "Storing databases",
      "Visualizing and monitoring data",
      "Creating websites"
    ],
    correctAnswer: "Visualizing and monitoring data"
  },
  {
    question: "Which Power BI feature is used to create calculations and measures?",
    options: [
      "SQL",
      "DAX",
      "Python",
